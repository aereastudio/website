...
const About = () => {
  return (
    <div id="about" className="centered-container pt5-ns">
      <div className="w-90 fr">
        ...
        <div className="flex-ns items-center-ns pb5">
          ...
          <div className="w-50-ns ml5-ns f6">
            <p className="mb2 lh-copy">
              <span className="b font-2">Somos un estudio creativo emergente</span> ubicado en Santiago de Chile y 
              fundado de manera virtual en medio de la pandemia del 2020. Utilizamos las herramientas del diseño gráfico 
              y la fotografía para construir piezas gráficas visualmente cautivadoras. Debido a las complicaciones de la 
              pandemia, desarrollamos una metodología de trabajo remoto para el desarrollo de nuestros proyectos.
            </p>
